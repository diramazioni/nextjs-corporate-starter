...
export default function Pricing({ data }: PriceProps) {
  return (
    <section className="py-20 bg-col dark:text-gray-100 m:py-12 lg:py-24">
      <div className="container px-4 mx-auto ">
        <div className="max-w-2xl mx-auto mb-16 text-center">
          <span className="font-bold tracking-wider uppercase dark:text-teal-400">
            Pricing
          </span>
            ...
            >
              <div
                className={`flex flex-col p-6 space-y-6 rounded shadow sm:p-8 min-h-[475px] min-w-[300px] ${
                  plan.isRecommended ? "dark:bg-teal-600" : "dark:bg-gray-800"
                }`}
              >
                ...
                <button
                  ...
                  className={`inline-block px-5 py-3 font-semibold tracking-wider text-center rounded   ${
                    plan.isRecommended
                      ? "dark:bg-gray-900 dark:text-teal-400"
